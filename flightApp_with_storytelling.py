...
def homepage():
    ...
    st.write("""
        ...
        - This means that the already poor ability to predict flight delays gets a lot worse :), if you would like a copy of an app that can run on your local machien with the full 2022 datset email me: goderisd@msu.edu.  I will be happy to send you the repo!
    """)
